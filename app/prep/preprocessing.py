...
# Construct absolute paths for model and tokenizer files
model_file = os.path.join(current_dir, 'model', 'onsite_request_model.h5')
tokenizer_file = os.path.join(current_dir, 'model', 'tokenizer_config.pkl')
...
try:
    ...
    raise ValueError(f"Unable to unpickle tokenizer from '{tokenizer_file}'.")
